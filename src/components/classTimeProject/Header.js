            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <p>
                        ...
                        to show class time on TV screens. <br />
                        The project is built in May 2019. I used pen and papre to build wireframe. 
                        and for development I used 
                        HTML, CSS (SCSS), JQuery, Ajax, JSON as a front-end almost and WAMP server
                        to deal with PHP, PHP myadmin, Apache, and MySQL database as the back-end<br/>
